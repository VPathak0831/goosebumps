...
get '/' do
	...
	@option1 = "Walk east, towards the light"
	@option2 = "Walk west, towards the rustling"
	erb :index
end

get '/direction/:choice' do
	case params[:choice]
		when "Walk west, towards the rustling"
			@image = ""
			...
			@option1 = "Join the group"
			@option2 = "Keep walking"
			erb :index	
		end

		when "Walk east, towards the light"
			@image ""
			...
			@option1 = "Get in the car"
			@option2 = "Walk away from the car"
			erb :index
		end
		...
		when "Walk away from the car"
			...
			@option1 = "Throw flashlight at raccoon"
			@option2 = "Throw candy at raccoon"
		end
		when "Throw flashight at raccoon"
			@image = ""
