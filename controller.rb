...
get '/direction/:choice' do
	case params[:choice]
	when "west"
		@websitesettings = ["", "You find another group of kids from the party. They say they know a place they can go for the night until they can call for help. They seem a little suspicious though… do you trust them?", "Join_the_group", "Keep_walking"]
		erb :index	

	when "east"
		@websitesettings = ["", "You walk towards the light, like some sort of dazed firefly.  The light leads to a banged up minivan that looks very similar to the way your parents’ car looked after you tried parallel parking for the first time.  You see the faces of a kindly elderly couple.  The driver smiles at you with her toothless gums.", "get_into_car", "Walk_away"]
		erb :index

	when "Join_the_group"
		@websitesettings = ["", "You join the group, and together you find a cabin in the woods. “Sweet place! Let’s stay here for a while,” Someone says. It looks cozy and welcoming. “What could go wrong?” you agree.  Upon entering the house, you are greeted by a small old woman, who promptly ushers you into the kitchen… specifically the oven. It dawns upon you what this trap is; you should’ve known better (the walls were made of gingerbread… yeah). Go back and try again."]
		erb :ending
